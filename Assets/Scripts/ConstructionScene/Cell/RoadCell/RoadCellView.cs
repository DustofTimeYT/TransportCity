...
public class RoadCellView : AbstractCellView
{
    ...
    protected override void OnUpdateView(AbstractCellModel AbstcellModel)
    {
        RoadCellModel cellModel = (RoadCellModel)AbstcellModel;
